...
settled claim is not a result, and the chapter is closed: 43 merging claims, 30 settled, 3
hypothesis, 10 refuted, with `scripts/build_claims_register.py` as the script of record
