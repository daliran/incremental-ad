...
#SBATCH --job-name=etth_forecast_model_6
...
# Generated by slurm_grid_search/harness.py -- trial: mae_tx_patch_len=8, mae_tx_encoder_embed_dim=64, seed=42
