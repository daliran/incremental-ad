...
#SBATCH --job-name=etth_forecast_train_incremental_0
...
# Generated by slurm_grid_search/harness.py -- trial: dataset_val_fraction=0.05, dataset_n_finetune_segments=2, seed=42
python -m incremental_ad.main \
    ...
    --dataset_val_fraction 0.05 \
    --dataset_n_finetune_segments 2 \
    --seed 42
