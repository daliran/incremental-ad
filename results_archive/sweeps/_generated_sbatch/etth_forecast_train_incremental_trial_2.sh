...
#SBATCH --job-name=etth_forecast_train_incremental_2
...
# Generated by slurm_grid_search/harness.py -- trial: pipeline_merge_scale=0.3, finetune_trainer_reg_lambda=1e-2, seed=42
python -m incremental_ad.main \
    ...
    --finetune_trainer_reg_lambda 1e-2 \
    --seed 42
