...
#SBATCH --job-name=etth_forecast_train_incremental_4
...
# Generated by slurm_grid_search/harness.py -- trial: pipeline_merge_scale=0.5, finetune_trainer_reg_lambda=1e-3, seed=42
