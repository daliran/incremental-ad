...
#SBATCH --job-name=etth_forecast_train_incremental_6
...
# Generated by slurm_grid_search/harness.py -- trial: pipeline_merge_scale=1.0, finetune_trainer_reg_lambda=0.0, seed=42
