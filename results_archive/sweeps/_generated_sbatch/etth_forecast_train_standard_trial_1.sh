...
#SBATCH --job-name=etth_forecast_train_standard_1
...
# Generated by slurm_grid_search/harness.py -- trial: dataset_val_fraction=0.05, trainer_learning_rate=3e-4, seed=42
