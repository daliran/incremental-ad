...
#SBATCH --job-name=etth_forecast_train_standard_3
...
# Generated by slurm_grid_search/harness.py -- trial: dataset_val_fraction=0.1, trainer_learning_rate=3e-4, seed=42
