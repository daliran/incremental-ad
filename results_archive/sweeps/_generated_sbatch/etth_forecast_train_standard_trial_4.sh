...
#SBATCH --job-name=etth_forecast_train_standard_4
...
# Generated by slurm_grid_search/harness.py -- trial: dataset_val_fraction=0.15, trainer_learning_rate=1e-3, seed=42
