...
#SBATCH --job-name=swat_train_incremental_0
...
# Generated by slurm_grid_search/harness.py -- trial: pipeline_merge_scale=0.3, finetune_trainer_reg_lambda=0.0, seed=42
