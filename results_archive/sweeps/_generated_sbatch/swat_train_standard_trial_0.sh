...
#SBATCH --job-name=swat_train_standard_0
...
# Generated by slurm_grid_search/harness.py -- trial: dataset_val_fraction=0.10, trainer_learning_rate=1e-4, seed=42
