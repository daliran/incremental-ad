...
# §1.38's P5 table at the paper's recommended threshold. Same column discipline as §1.37:
# the regex steps over the P4 column and captures the P5 one, so a check cannot pass by
# matching the wrong column of the same row.
CHECKS += [
    ('§1.38 ETTh1 n=2 P5 delta', '\\| ETTh1 \\| 2 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P5_opcm_distance", "dataset": 'ETTh1', "n_segments": '2', "variant_label": 'paper projection at matched distance, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.38 ETTh1 n=3 P5 delta', '\\| ETTh1 \\| 3 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P5_opcm_distance", "dataset": 'ETTh1', "n_segments": '3', "variant_label": 'paper projection at matched distance, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.38 ETTh1 n=5 P5 delta', '\\| ETTh1 \\| 5 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P5_opcm_distance", "dataset": 'ETTh1', "n_segments": '5', "variant_label": 'paper projection at matched distance, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.38 ETTh2 n=2 P5 delta', '\\| ETTh2 \\| 2 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P5_opcm_distance", "dataset": 'ETTh2', "n_segments": '2', "variant_label": 'paper projection at matched distance, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.38 ETTh2 n=3 P5 delta', '\\| ETTh2 \\| 3 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P5_opcm_distance", "dataset": 'ETTh2', "n_segments": '3', "variant_label": 'paper projection at matched distance, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.38 ETTh2 n=5 P5 delta', '\\| ETTh2 \\| 5 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P5_opcm_distance", "dataset": 'ETTh2', "n_segments": '5', "variant_label": 'paper projection at matched distance, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.38 ETTm2 n=2 P5 delta', '\\| ETTm2 \\| 2 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P5_opcm_distance", "dataset": 'ETTm2', "n_segments": '2', "variant_label": 'paper projection at matched distance, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.38 ETTm2 n=3 P5 delta', '\\| ETTm2 \\| 3 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P5_opcm_distance", "dataset": 'ETTm2', "n_segments": '3', "variant_label": 'paper projection at matched distance, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.38 ETTm2 n=5 P5 delta', '\\| ETTm2 \\| 5 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P5_opcm_distance", "dataset": 'ETTm2', "n_segments": '5', "variant_label": 'paper projection at matched distance, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.38 exchange n=2 P5 delta', '\\| exchange \\| 2 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P5_opcm_distance", "dataset": 'exchange', "n_segments": '2', "variant_label": 'paper projection at matched distance, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.38 exchange n=3 P5 delta', '\\| exchange \\| 3 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P5_opcm_distance", "dataset": 'exchange', "n_segments": '3', "variant_label": 'paper projection at matched distance, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.38 exchange n=5 P5 delta', '\\| exchange \\| 5 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P5_opcm_distance", "dataset": 'exchange', "n_segments": '5', "variant_label": 'paper projection at matched distance, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.38 PSM-forecast n=2 P5 delta', '\\| PSM-forecast \\| 2 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P5_opcm_distance", "dataset": 'PSM-forecast', "n_segments": '2', "variant_label": 'paper projection at matched distance, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.38 PSM-forecast n=3 P5 delta', '\\| PSM-forecast \\| 3 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P5_opcm_distance", "dataset": 'PSM-forecast', "n_segments": '3', "variant_label": 'paper projection at matched distance, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.38 PSM-forecast n=5 P5 delta', '\\| PSM-forecast \\| 5 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P5_opcm_distance", "dataset": 'PSM-forecast', "n_segments": '5', "variant_label": 'paper projection at matched distance, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.38 SWaT-forecast n=2 P5 delta', '\\| SWaT-forecast \\| 2 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P5_opcm_distance", "dataset": 'SWaT-forecast', "n_segments": '2', "variant_label": 'paper projection at matched distance, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.38 SWaT-forecast n=3 P5 delta', '\\| SWaT-forecast \\| 3 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P5_opcm_distance", "dataset": 'SWaT-forecast', "n_segments": '3', "variant_label": 'paper projection at matched distance, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.38 SWaT-forecast n=5 P5 delta', '\\| SWaT-forecast \\| 5 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P5_opcm_distance", "dataset": 'SWaT-forecast', "n_segments": '5', "variant_label": 'paper projection at matched distance, thr=0.5'},
     "delta_pct", 0.02),
]

# §1.37's P4 tables (both halves), at the paper's recommended threshold, which is what the
# section publishes. The regex skips the P1 column and captures the P4 one, so a check
# cannot pass by matching the wrong column of the same row.
CHECKS += [
    ('§1.37 ETTh1 n=2 P4 delta', '\\| ETTh1 \\| 2 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P4_opcm_committed", "dataset": 'ETTh1', "n_segments": '2', "variant_label": 'paper projection at committed alpha, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.37 ETTh1 n=3 P4 delta', '\\| ETTh1 \\| 3 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P4_opcm_committed", "dataset": 'ETTh1', "n_segments": '3', "variant_label": 'paper projection at committed alpha, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.37 ETTh1 n=5 P4 delta', '\\| ETTh1 \\| 5 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P4_opcm_committed", "dataset": 'ETTh1', "n_segments": '5', "variant_label": 'paper projection at committed alpha, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.37 ETTh2 n=2 P4 delta', '\\| ETTh2 \\| 2 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P4_opcm_committed", "dataset": 'ETTh2', "n_segments": '2', "variant_label": 'paper projection at committed alpha, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.37 ETTh2 n=3 P4 delta', '\\| ETTh2 \\| 3 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P4_opcm_committed", "dataset": 'ETTh2', "n_segments": '3', "variant_label": 'paper projection at committed alpha, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.37 ETTh2 n=5 P4 delta', '\\| ETTh2 \\| 5 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P4_opcm_committed", "dataset": 'ETTh2', "n_segments": '5', "variant_label": 'paper projection at committed alpha, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.37 ETTm2 n=2 P4 delta', '\\| ETTm2 \\| 2 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P4_opcm_committed", "dataset": 'ETTm2', "n_segments": '2', "variant_label": 'paper projection at committed alpha, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.37 ETTm2 n=3 P4 delta', '\\| ETTm2 \\| 3 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P4_opcm_committed", "dataset": 'ETTm2', "n_segments": '3', "variant_label": 'paper projection at committed alpha, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.37 ETTm2 n=5 P4 delta', '\\| ETTm2 \\| 5 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P4_opcm_committed", "dataset": 'ETTm2', "n_segments": '5', "variant_label": 'paper projection at committed alpha, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.37 exchange n=2 P4 delta', '\\| exchange \\| 2 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P4_opcm_committed", "dataset": 'exchange', "n_segments": '2', "variant_label": 'paper projection at committed alpha, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.37 exchange n=3 P4 delta', '\\| exchange \\| 3 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P4_opcm_committed", "dataset": 'exchange', "n_segments": '3', "variant_label": 'paper projection at committed alpha, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.37 exchange n=5 P4 delta', '\\| exchange \\| 5 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P4_opcm_committed", "dataset": 'exchange', "n_segments": '5', "variant_label": 'paper projection at committed alpha, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.37 SWaT n=2 P4 delta', '\\| SWaT \\| 2 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P4_opcm_committed", "dataset": 'SWaT', "n_segments": '2', "variant_label": 'paper projection at committed alpha, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.37 SWaT n=3 P4 delta', '\\| SWaT \\| 3 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P4_opcm_committed", "dataset": 'SWaT', "n_segments": '3', "variant_label": 'paper projection at committed alpha, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.37 SWaT n=5 P4 delta', '\\| SWaT \\| 5 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P4_opcm_committed", "dataset": 'SWaT', "n_segments": '5', "variant_label": 'paper projection at committed alpha, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.37 PSM n=2 P4 delta', '\\| PSM \\| 2 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P4_opcm_committed", "dataset": 'PSM', "n_segments": '2', "variant_label": 'paper projection at committed alpha, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.37 PSM n=3 P4 delta', '\\| PSM \\| 3 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P4_opcm_committed", "dataset": 'PSM', "n_segments": '3', "variant_label": 'paper projection at committed alpha, thr=0.5'},
     "delta_pct", 0.02),
    ('§1.37 PSM n=5 P4 delta', '\\| PSM \\| 5 \\| [+-][\\d.]+% \\| ([+-][\\d.]+)% \\| [+-][\\d.]+ pp \\|',
     "remerge_closeout/remerge_closeout.csv",
     {"test": "P4_opcm_committed", "dataset": 'PSM', "n_segments": '5', "variant_label": 'paper projection at committed alpha, thr=0.5'},
     "delta_pct", 0.02),
]
