...
#SBATCH --job-name=etth_imputation_eval
...
# CHECKPOINT: full path to the checkpoint. For StandardPipeline output:
#   $RUNS_ROOT/<experiment_name>/<run_id>/train/checkpoints/best.pt
CHECKPOINT=$RUNS_ROOT/mae_tx_etth_imputation/<run_id>/train/checkpoints/best.pt
